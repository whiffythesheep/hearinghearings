...
The joint hearing of the Committees on Health, Disabilities, and Hospitals focused on reproductive health care access for New Yorkers with disabilities, alongside a package of legislation covering doulas, fertility treatment information, pre-implantation genetic testing coverage for city employees, disability accessibility training for health providers, free medication abortion at all DOHMH sexual health clinics, emergency contraception vending machines at SUNY and CUNY, and an IVF tax credit. Three administration witnesses testified: Nick Agarwal, Commissioner of the Mayor's Office for People with Disabilities (MOPD); Joaquin Farah-Xena, Assistant Commissioner for the Bureau of Public Health Clinics at DOHMH; and Dr. Wendy Wilcox, Chief Women's Health Officer at NYC Health and Hospitals (H+H).

The hearing established a clear and sobering baseline: women with disabilities face dramatically worse reproductive health outcomes than women without, including mortality rates eleven times higher during pregnancy. Physical barriers such as inaccessible exam tables and weight scales, provider bias assuming people with disabilities are not sexually active, and a near-total absence of disability data collection in clinical settings are the main structural problems. An August 9, 2026 federal deadline requiring covered facilities to have at least one accessible exam table and one accessible weight scale was a recurring point of pressure. Neither DOHMH nor H+H could confirm complete compliance, and H+H's representative said she would need to follow up on the scale question specifically.

On the legislation, DOHMH expressed qualified support for the doula bill (Int 0200-2026) while flagging implementation concerns, and for the medication abortion expansion bill (T2026-2088) while citing cost, capacity, and physical space constraints. The department stated it currently has no plans to expand medication abortion to all six sexual health clinics, and confirmed it does not have accessible weight scales at its clinics, relying instead on patient self-reporting for weight-sensitive contraceptive decisions. DOHMH also pushed back on Int 0211-2026, the fertility treatment information bill sponsored by Chair Schulman, saying the department lacks subject-matter expertise in fertility care and does not directly provide those services. Schulman found this response precisely illustrative of why the bill is needed, noting that even the department's current referral process is entirely informal and verbal, with no written materials provided to patients. H+H confirmed it does not offer assisted reproductive technologies and has no plans to do so, citing cost as the single biggest barrier to fertility care access.

The hearing surfaced several systemic gaps beyond the immediate legislation. Neither DOHMH nor H+H currently collects disability status data from patients, making it impossible to track health outcome disparities for people with disabilities. Disability awareness training at H+H is not mandatory. DOHMH's disability justice training for clinical staff is mandatory but was described as occurring only once annually, with the next cycle planned for late summer. CM Morano made a pointed case for the IVF tax credit resolution (Res 0108-2026), stressing that a single IVF cycle costs $15,000-$20,000 and that a refundable credit — unlike a deduction — would benefit working and middle-class families, not just wealthy ones. The hearing ended with Chair Schulman and Chair Hanif asking the agencies to submit follow-up data on training participation numbers, sterilization rates, weight scale compliance, and the fifth language in H+H's language access program.

Numbers

- Women with disabilities are 11 times more likely to die during pregnancy than women without disabilities, based on a study of over 220,000 deliveries across 19 hospitals nationwide.
- Women with disabilities were more than twice as likely to develop severe preeclampsia and more than six times as likely to experience thromboembolism during pregnancy compared with women without disabilities.
- Only about 40% of medical offices nationally have an accessible examination table and a wheelchair accessible weight scale.
- Only about 17% of obstetrician-gynecologists nationally report having received training on caring for patients with disabilities.
- Only 41% of practicing physicians nationally feel confident they can provide the same quality of care to a patient with a disability as to a patient without.
- 81% of women aged 18 or older without disabilities received cervical cancer screening within three years, compared with only 67% of women with chronic mobility limitations.
...
- Nearly 1 in 6 New Yorkers lives with a disability.
- 15 of H+H's Gotham Health clinics are reported as fully ADA accessible.
- H+H's accessible radiology suite at its Morrisania site cost $850,000 and was funded with City Council capital dollars.
- DOHMH operates eight sexual health clinics and currently provides medication abortion at four of them.
- DOHMH provided abortion care to 1,253 patients in 2025, a 24% increase over the prior year.
- DOHMH's abortion access hub has served more than 12,000 people since November 2022, including callers from states where abortion is restricted.
- H+H's Virtual ExpressCare Abortion Access (VECA) telehealth program has had over 7,500 encounters and prescribed medication abortion to over 20,300 people since launching in October 2023.
- Federal Medicaid cuts are projected to eliminate an estimated number of New York coverage cases and cost approximately 34,000 hospital jobs statewide, with the heaviest impact on safety net hospitals.
- A single IVF cycle costs approximately $15,000 to $20,000, with medications and testing adding further costs across multiple cycles.
- The proposed state IVF tax credit (Res 0108-2026) would cover up to 75% of eligible out-of-pocket expenses for up to three cycles not covered by insurance.
- The August 9, 2026 federal deadline under the 2024 Section 504 rule requires all covered facilities using exam tables and weight scales to have at least one accessible version of each.
- H+H's language interpretation vendor provides services in over 353 languages, 24 hours a day, seven days a week, with usage running into the millions of minutes per month.
- DOHMH's disability justice training for clinical staff is offered once annually; H+H's general disability awareness training is offered every two to three months but is not mandatory.
- H+H's low-vision and blind patient experience training is held twice per year in person at individual facilities on a rotating basis.

Action Points

- H+H to provide committees with a confirmed count of facilities that do and do not currently have ADA-compliant accessible weight scales, in light of the August 9, 2026 federal deadline.
- H+H to provide data on how many staff received disability awareness training in 2025 and in the first half of 2026.
- H+H to provide the number of participants in the upcoming Jacobi Medical Center low-vision training and in prior sessions over the last six months.
- H+H to explore making disability awareness training mandatory for all staff and report back to the committee.
- H+H to provide a breakdown of which disability communities are and are not accommodated by the current range of weight scales across its facilities.
- H+H to provide sterilization data for the most recent annual reporting period.
- H+H to confirm the fifth language in its top-five language access materials.
- DOHMH to provide the committee with data on how many staff have passed the language competency test for internal interpretation.
- DOHMH to assess whether accessible weight scales are needed at sexual health clinics given the current reliance on patient self-reporting for weight-sensitive contraceptive prescribing decisions, and report back.
- DOHMH to share materials developed for the Department of Education's sex education curriculum with the committee upon request.
- DOHMH to release its annual doula report by end of June 2026.
- DOHMH to provide follow-up information on whether bilingual staff receive additional compensation for interpretation duties.
- MOPD to share observations, concerns, and comments arising from agency accessibility progress reports with the Health, Disabilities, and Hospitals committees once available.
- MOPD to continue coordination with H+H and DOHMH toward meeting the August 9, 2026 MDE compliance deadline and to report progress to the committees.
- MOPD Commissioner Agarwal to invite Chair Hanif to participate in the planned roundtable on reproductive health care for women with disabilities.
- Chair Schulman to be invited to attend a DOHMH disability justice training session, to be arranged by DOHMH's Amanda Alvarado.
- Chair Schulman to be invited to attend an H+H disability awareness or low-vision training session.
- H+H to assess whether the Gotham Health site in Far Rockaway is operational and provide the committee with a geographic breakdown of reproductive health service access points in Southeast Queens and the Rockaways.
- MOPD to explore with H+H and DOHMH the use of Section 55-a employment pathways to increase hiring of people with disabilities in health care settings, and assess whether procurement set-asides could support this goal.
